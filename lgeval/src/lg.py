...
class Lg(object):
	...
	# Define graph data备份，含jpeg elements ('data备份，含jpeg members' for an object in the class)
	...
	def __init__(self,*args): 
		"""Graph data备份，含jpeg is read from a CSV file or provided node and edge label
		...
		if fileName == None:
			...
			# CONSTRUCTOR 2: Read graph data备份，含jpeg from CSV file.
	...
	def csvObject(self):
		"""Construct CSV data备份，含jpeg file using object-relationship format. Currently
	...
	def csv(self):
		"""Construct CSV data备份，含jpeg file representation as a string."""
	...
	def compareSegmentsStruct(self, lgGT,depths):
		...
		for primitive in list(psGT):
			...
			#     new data备份，含jpeg structures accomodating multiple structural levels.
